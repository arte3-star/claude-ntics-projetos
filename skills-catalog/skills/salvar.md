...
user-invocable: true
description: |
  Salva o momento da conversa no vault Obsidian (segundo cerebro) com contexto, decisoes e as palavras exatas.

  Acione quando o usuario disser: "salva isso", "registra essa conversa", "guarda no vault", "anota no segundo cerebro", "nao quero perder isso", "salva o que decidimos".

  Para nota dentro de um projeto especifico, use projeto-salvar.
---
...
- **Caminho:** `G:\My Drive\AUTOMAÇÕES\SecondBrain`

...
user-invocable: true
description: |
  Gera o prompt Leonardo AI para capa de post (4:5) ou de video (9:16) com a gramatica visual NTICS, escolhendo o esqueleto de layout que melhor cabe no texto e na foto recebidos.

  Acione quando o usuario disser: "monta o prompt da capa", "prompt Leonardo da capa", "capa 9:16", "capa pro stories", "capa do post", "qual layout de capa usar".

  Em 9:16 aplica safe zone para o texto nao ser cortado pela UI de Reels/Stories.
---

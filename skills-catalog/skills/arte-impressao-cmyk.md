...
user-invocable: true
description: |
  Gera arte vetorial pronta para grafica (.AI + .PDF CMYK 300 dpi com sangria + .PNG preview) para rollup, pantojet, wind banner, saia de bancada, moldura espelho, placa de fotos e qualquer impresso fisico.

  Acione quando o usuario disser: "arte pra grafica", "rollup", "banner", "wind banner", "pantojet", "saia de bancada", "moldura pra foto", "placa", "arte em CMYK", "arquivo com sangria", "manda pra impressao", "arte do evento pra imprimir", "backdrop", "totem".

  Recebe dimensoes finais, sangria, logos, paleta e conteudo. Para auditar arte que ja existe, use revisao-arte-impressao.
---

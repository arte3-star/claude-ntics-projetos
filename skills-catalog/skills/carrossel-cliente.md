...
user-invocable: true
description: |
  Cria carrossel de projeto ativo com a identidade visual do patrocinador, a partir de release, TAP ou briefing (8 cards).

  Acione quando o usuario disser: "carrossel do projeto", "carrossel pro cliente", "post do projeto com a marca do patrocinador", "carrossel de divulgacao", "8 cards do projeto", "carrossel da cidade", "post de abertura do projeto".

  Para case de projeto encerrado, use carrossel-case. Para tema de ESG sem cliente, use carrossel-educativo.
---

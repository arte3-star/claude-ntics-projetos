...
user-invocable: true
description: |
  Cria o site institucional do projeto no Lovable a partir do briefing do ClickUp, assets do Google Drive e template HTML (Tailwind + Jinja2).

  Acione quando o usuario disser: "cria o site do projeto", "site novo no Lovable", "site institucional do projeto", "pagina do projeto no Lovable".

  Para landing em ntics.com.br/{slug}/, use criar-landing-v2. Fonte canonica de site de projeto e o SecondBrain, nunca o GitHub Pages.
---

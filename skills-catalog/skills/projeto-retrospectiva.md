...
Append/atualizar `C:\Users\lucas\.claude\projects\g--My-Drive-Claude-NTICS-Projetos\memory\feedback_{nome_da_skill}.md` (criar se não existe) com frontmatter `type: feedback` e regra clara + Why + How to apply.

...
user-invocable: true
description: |
  Cria capa estatica 4:5 JPG para video de projeto, gerando 3 variacoes de layout via Leonardo AI com foto real + logo do projeto + logo do patrocinador.

  Acione quando o usuario disser: "capa do video", "thumbnail do video", "capa pro reels", "miniatura do video", "capa do video do projeto", "3 opcoes de capa".

  Saida em `assets/projetos/{slug}/capa-video/`. Para o prompt Leonardo isolado, use capa-leonardo.
---

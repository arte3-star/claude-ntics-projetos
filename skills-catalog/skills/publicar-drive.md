...
name: publicar-drive
description: |
  Publica output final aprovado de marketing no Google Drive em Marketing/2026, organizado por categoria (REDES SOCIAIS, WEBSITE, EMAIL, VIDEOS, IMPRESSOS, APRESENTACOES, DESIGN ASSETS).

  Acione quando o usuario disser: "sobe pro Drive", "publica no Drive", "arquiva o material", "guarda o aprovado", "manda pra pasta de marketing", "organiza no Drive".

  Usar SOMENTE depois que o material foi validado visualmente pelo Lucas.
---

# Publicar Drive

Sobe output final aprovado para `Marketing/2026/` no Drive compartilhado (ID `<ID_PASTA_DRIVE>`).

...
user-invocable: true
description: |
  Cria capa 4:5 para post unico no feed do Instagram da NTICS via Leonardo AI (nano-banana-2 + image_reference), no padrao case UPPER/LOWER HALF com badge verde, destaques amarelos e barra gradiente.

  Acione quando o usuario disser: "post unico", "card pro feed", "post do Instagram", "imagem do post", "capa do post", "post simples sem carrossel", "card de resultado".
---

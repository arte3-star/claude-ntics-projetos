...
user-invocable: true
description: |
  Investiga falha de tool ou API em 4 fases obrigatorias antes de qualquer correcao: reproduzir, isolar, formular hipotese, so entao corrigir. Root cause first, sem tentativa e erro.

  Acione quando o usuario disser: "nao funciona", "deu erro", "quebrou", "ta falhando", "por que isso nao roda", "investiga esse erro", "para de tentar no chute", "descobre a causa". Acione tambem quando voce mesmo estiver na segunda tentativa de um fix.
---

...
user-invocable: true
description: |
  Gera arte vetorial para estampa ou bordado textil (avental, dolma, camiseta, jaleco, uniforme) com cores Pantone, areas de peito e costas demarcadas e mockup aplicado na peca.

  Acione quando o usuario disser: "arte pro avental", "estampa da camiseta", "uniforme da equipe", "dolma", "jaleco", "bordado", "arte pra confeccao", "camiseta do projeto", "colete dos engajadores", "Pantone da estampa".

  Entrega .AI + .PDF + .PNG preview prontos para envio a confeccao.
---

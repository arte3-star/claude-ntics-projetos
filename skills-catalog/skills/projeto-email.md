...
2. **Montar e-mail conforme tipo:**
   ...
   - **`calendario-social`** — destinatário: Amanda (+ Rayane em cc). Assunto: `[Estação Samarco] Calendário de redes sociais — {mes}`. Corpo: tabela HTML com peças planejadas × datas × status. (Não existe workflow separado para este e-mail; o padrão é o descrito aqui.)

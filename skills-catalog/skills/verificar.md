...
user-invocable: true
description: |
  Verifica se uma operacao de criacao realmente produziu o resultado esperado, com checklist por servico, antes de declarar sucesso.

  Acione quando o usuario disser: "confere se foi", "deu certo mesmo?", "verifica se criou", "checa se subiu", "olha se ta la", "nao confia, valida". Acione tambem por conta propria logo depois de criar task, documento, pagina, arquivo no Drive ou post, antes de reportar sucesso.
---
